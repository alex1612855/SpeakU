    ...
    <View style={styles.iphone1313ProCodeInpu}>
      ...
      <View style={styles.authInputWrapper}>
        <View style={styles.authInput}>
          <Text style={[styles.everyMorningIContainer, styles.goBackTypo]}>
            <Text style={styles.everyMorningI}>{`Every morning, I `}</Text>
            <Text style={styles.kfvfkvncfjvnfjvnfjvn}>
              kfvfkvncfjvnfjvnfjvn
            </Text>
            <Text
              style={styles.everyMorningI}
            >{` my backpack and get ready for school. Before leaving, I `}</Text>
            <Text style={styles.kfvfkvncfjvnfjvnfjvn}>dvkjddndckdjcndkk</Text>
            <Text
              style={styles.everyMorningI}
            >{` my breakfast, usually cereal or toast. While eating, I `}</Text>
            <Text style={styles.kfvfkvncfjvnfjvnfjvn}>
              oijoibjfgobicbgilcgb
            </Text>
            <Text
              style={styles.everyMorningI}
            >{` a chapter of my favorite book. Once done, I `}</Text>
            <Text style={styles.kfvfkvncfjvnfjvnfjvn}>dclkdmcdmcldcl</Text>
            <Text
              style={styles.everyMorningI}
            >{` a short summary about it in my journal, trying to `}</Text>
            <Text style={styles.kfvfkvncfjvnfjvnfjvn}>dlkxmvlxkmvlxkmvxl</Text>
            <Text style={styles.everyMorningI}>{`  the main ideas. `}</Text>
          </Text>
          <View style={styles.button}>
            <Text style={[styles.nextWord, styles.title1Typo]}>Next text</Text>
          </View>
        </View>
      </View>
        ...
        <View style={styles.tabs}>
          ...
          <View style={[styles.view3, styles.viewPosition]}>
            <Image
              style={[styles.outlinecalendarIcon, styles.iconPosition]}
              resizeMode="cover"
              source={require("../assets/24outlineprofile2.png")}
            />
            <Text style={[styles.sfSymbol, styles.sfSymbolFlexBox]}>􀎞</Text>
...
export default IPhone1313ProCodeInpu12;
