      ...
      <View style={styles.authInputWrapper}>
        <View style={styles.authInput}>
          <Text style={[styles.everyMorningIContainer, styles.goBackTypo]}>
            ...
            <Text style={styles.dvkjddndckdjcndkk}>dvkjddndckdjcndkk</Text>
            <Text
              style={styles.everyMorningI}
            ...
            <Text style={styles.dvkjddndckdjcndkk}>dclkdmcdmcldcl</Text>
            <Text
              style={styles.everyMorningI}
            >{` a short summary about it in my journal, trying to `}</Text>
            <Text style={styles.dvkjddndckdjcndkk}>dlkxmvlxkmvlxkmvxl</Text>
            <Text style={styles.everyMorningI}>{`  the main ideas. `}</Text>
          </Text>
          <View style={styles.button}>
            <Text style={[styles.nextWord, styles.title1Typo]}>Try again</Text>
          </View>
        </View>
      </View>
...
export default IPhone1313ProCodeInpu13;
